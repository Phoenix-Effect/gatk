...
# Directories
FQ_DIR = config["directory"]["fastq_files"] # path to directory with trimmed FASTQ files
SAM_AL_DIR = config["directory"]["sam_alignment_files"] # path to directory for SAM alignment files
BAM_AL_DIR = config["directory"]["bam_alignment_files"] # path to directory for BAM alignment files
...
XX_REF_VIRAL_GENOMES = config["directory"]["XX_ref_with_viral_genomes"] # Reference genome files: XX with Y chromosome masked
XY_WITHOUTYPAR_VIRAL_REF_GENOMES = config["directory"]["XX_withoutYpar_ref_with_viral_genomes"] # Reference genome files: XY with both Y-chromosomal PAR masked
...
rule hisat2_xx_align_reads:
	...
	params:
		XX_hisat2_index = XX_REF_VIRAL_GENOMES,
		XY_hisat2_index = XY_WITHOUTYPAR_VIRAL_REF_GENOMES,
		threads = 8
